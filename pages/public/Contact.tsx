            ...
            <div className="bg-oxford-blue p-4 sm:p-6 md:p-8 rounded-3xl border border-yinmn-blue/30">
                <form onSubmit={handleSubmit} className="space-y-4 text-left">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea rows={4} value={data.message} onChange={e => setData(d => ({ ...d, message: e.target.value }))} required placeholder="Tell me about your project or idea..."
                            className="w-full bg-space-cadet border border-yinmn-blue/30 rounded-lg px-4 py-3 focus:border-cyan-accent focus:ring-1 focus:ring-cyan-accent/40 outline-none transition-colors text-white placeholder-slate-600 resize-none" />
                    </div>
